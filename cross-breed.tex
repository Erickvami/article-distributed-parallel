...
monolithic to serverless architectures, in this case we are using AWS lambda functions, as seen in Table~\ref{table:architectures}.     
...
This component receives the configuration parameters of
 ...
 Once a subpopulation is processed, the manager pulls
  ...
  parallel messages, which are resent back to their respective queues  to AWS lambda functions that internaly has 
