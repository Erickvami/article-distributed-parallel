...
but in the second offspring the "0" values indicates where to swap individuals/vectors, for "1" 
 ...
 2 and 5 the middle point would be 3.5.
 % Not clear. Maybe a
                                % picture? - JJ
...
The computational resources that we select to execute our experiments is a Dell Poweredge R730, 
2 processors Intel Xeon E5-2670v3 12 core, Hard drive 1TB, RAM 128GB, Ubuntu Server 18.04 Operator System.
%
