...
and sometimes traditional methods are too slow or fail to find an optimal
solution. % What do you mean by "traditional" methods? - JJ
...
parallel and hybrid architectures have been proposed. % Parallel
...
architecture that
processes small fragments % small? fragments? Aren't they independent populations?
from a population in a distributed way, turning a
population into a multi-population. % they're simply independent
                                % populations - JJ
