...
and sometimes conversional algorithms like Genetic Algorithms or Particle Swarm Optimization, for their own are too slow or fail to find an optimal
solution. As the known No Free Lunch theorem says there is no perfect algorithm that will work for everything and % What do you mean by "traditional" methods? - JJ
