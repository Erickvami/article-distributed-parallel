...
%
\author{\anonymize{Erick Vargas Minguela}\inst{1}\orcidID{0000-1111-2222-3333} \and
\anonymize{Mario Garcia Valdez}\inst{1}\orcidID{1111-2222-3333-4444} \and
\anonymize{Third Author}\inst{2}\orcidID{2222--3333-4444-5555}}
%
\authorrunning{\anonymize{E. Vargas Minguela} et al.}
% First names are abbreviated in the running head.
% If there are more than two authors, 'et al.' is used.
%
\institute{National Technological Institute of Mexico 
\email{\anonymize{erick.vargas.minguela@gmail.com}}\\
